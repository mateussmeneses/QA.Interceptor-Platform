...
> Este arquivo permanece como historico priorizado e referencia de escopo.
> Execucao atual deve usar `BACKLOG_CONSOLIDATED.md` (raiz do repositorio).
> Atualizacoes de status oficiais devem ocorrer apenas em `docs/backlog/BACKLOG_CANONICAL.md`.
