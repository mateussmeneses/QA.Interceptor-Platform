...
> Governance note: partes deste indice referenciam snapshots historicos de fase.
> Para execucao atual, use primeiro `BACKLOG_CONSOLIDATED.md` e `docs/backlog/BACKLOG_CANONICAL.md`.
> Para auditoria e reestruturacao atual, use `PROJECT_AUDIT.md`, `ARCHITECTURE_REVIEW.md`, `TECHNICAL_DEBT.md` e `REFACTORING_PLAN.md`.
...
1. **[IMPLEMENTATION_READY.md](../planning/IMPLEMENTATION_READY.md)** ⭐ Executive summary + next steps
2. **[FRONTEND_QUICK_START.md](../architecture/FRONTEND_QUICK_START.md)** ⭐ 30-minute setup guide (start coding today)
3. **[DESIGN_SYSTEM.md](../architecture/DESIGN_SYSTEM.md)** Design tokens, colors, typography, components
4. **[BACKLOG_FRONTEND.md](../backlog/BACKLOG_FRONTEND.md)** 72 concrete tasks (FE-0 through FE-6)

### For Backend Developers

1. **[ARCHITECTURE.md](../architecture/ARCHITECTURE.md)** Full project architecture
2. **[docs/adr/](../adr/)** 6 Architectural Decision Records
...
1. **[PROJECT_STATUS.md](../analysis/PROJECT_STATUS.md)** Current phase + timeline
2. **[PRODUCT_VISION.md](../../PRODUCT_VISION.md)** Product strategy + north star
3. **[UI_UX_PREVIEW.md](../architecture/UI_UX_PREVIEW.md)** Visual mockups + layouts
4. **[BACKLOG_FRONTEND.md](../backlog/BACKLOG_FRONTEND.md)** Feature priority + effort
...
3. **[docs/adr/ADR-001.md](../adr/ADR-001-feature-based-module-architecture.md)** Architecture decisions
...
| **Phase 3.6 (Current)** | Frontend\_\*.md documents (6 files) |
